...
<section class="services">
    ...
    <div class="fotorama" data-minwidth="100%" data-maxheight="760" data-fit="scaledown" data-nav="false"
         data-autoplay="true">
            ...
            <div class="services__container__col">
                ...
                <div class="services__text">
                    <div class="services__text--box">
                        ...
                        <p>Наше мероприятие стало лидером рынка, который собирает многотысячные залы, нас приглашают в
                            разные города и страны.</p>
                    </div>
                </div>
            </div>
        </div>
...
<section class="contactinfo">
    <div class="contain">
        <div class="contactinfo__block">
            <h3>контакты</h3>
            <div class="row">
                <?php if (get_theme_mod('tw_textbox') != '') { ?><a target="_blank"
                                                                    href="<?php echo get_theme_mod('tw_textbox'); ?>" >
                        <i class="fa fa-twitter"></i></a><?php } ?>
                <?php if (get_theme_mod('fb_textbox') != '') { ?><a target="_blank"
                                                                    href="<?php echo get_theme_mod('fb_textbox'); ?>" >
                        <i class="fa fa-facebook"></i></a><?php } ?>
                <?php if (get_theme_mod('p_textbox') != '') { ?><a target="_blank"
                                                                   href="<?php echo get_theme_mod('p_textbox'); ?>" ><i
                            class="fa fa-pinterest"></i></a><?php } ?>
                <?php if (get_theme_mod('gpl_textbox') != '') { ?><a target="_blank"
                                                                     href="<?php echo get_theme_mod('gpl_textbox'); ?>" >
                        <i class="fa fa-google-plus"></i></a><?php } ?>
                <?php if (get_theme_mod('vk_textbox') != '') { ?><a target="_blank"
                                                                    href="<?php echo get_theme_mod('vk_textbox'); ?>" >
                        <i class="fa fa-vk"></i></a><?php } ?>
                <?php if (get_theme_mod('in_textbox') != '') { ?><a target="_blank"
                                                                    href="<?php echo get_theme_mod('in_textbox'); ?>" >
                        <i class="fa fa-instagram"></i></a><?php } ?>
                <?php if (get_theme_mod('ok_textbox') != '') { ?><a target="_blank"
                                                                    href="<?php echo get_theme_mod('ok_textbox'); ?>" >
                        <i class="fa fa-odnoklassniki"></i></a><?php } ?>
                <?php if (get_theme_mod('yt_textbox') != '') { ?><a target="_blank"
                                                                    href="<?php echo get_theme_mod('yt_textbox'); ?>" >
                        <i class="fa fa-youtube"></i></a><?php } ?>
                <?php if (get_theme_mod('vim_textbox') != '') { ?><a target="_blank"
                                                                     href="<?php echo get_theme_mod('vim_textbox'); ?>" >
                        <i class="fa fa-vimeo"></i></a><?php } ?>
                <?php if (get_theme_mod('tm_textbox') != '') { ?><a target="_blank"
                                                                    href="<?php echo get_theme_mod('tm_textbox'); ?>" >
                        <i class="fa fa-tumblr"></i></a><?php } ?>
                <?php if (get_theme_mod('sk_textbox') != '') { ?><a target="_blank"
                                                                    href="<?php echo get_theme_mod('sk_textbox'); ?>" >
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="input-group input-group">
                        ...
                        <input type="text" name="order-name" class="form-control" placeholder="Укажите ваше имя"
                               aria-describedby="sizing-addon1">
                    </div>
                    <br>
                    <div class="input-group input-group">
                        <span class="input-group-addon" id="sizing-addon1">E-mail</span>
                        <input type="email" name="order-mail" class="form-control" placeholder="Укажите ваш e-mail"
                               aria-describedby="sizing-addon1">
                    </div>
                    <br>
                </div>
